...
namespace Carable
{
    public static class CollectionChangesExtensions
    {
        ...
        public static CollectionChanges<T,T> CollectionChanges<T, TKey>(this IEnumerable<T> existing, IEnumerable<T> updated, Func<T, TKey> keySelector)
        {
            return CollectionChanges(existing, 
                keySelector, 
                updated, 
                keySelector);
        }

        public static CollectionChanges<TExisting, TUpdated> CollectionChanges<TExisting, TUpdated, TKey>(this IEnumerable<TExisting> existing,
